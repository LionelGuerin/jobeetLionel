...
class JobControllerTest extends WebTestCase
{
    ...
    public function testIndex()
    {
        ...
        $this->assertEquals('Ens\LionelBundle\Controller\JobController::indexAction', $client->getRequest()->attributes->get('_controller'));
        ...
        $this->assertEquals('Ens\LionelBundle\Controller\JobController::showAction', $client->getRequest()->attributes->get('_controller'));
    ...
    public function testJobForm()
    {
        ...
        $this->assertEquals('Ens\LionelBundle\Controller\JobController::newAction', $client->getRequest()->attributes->get('_controller'));
        ...
        $client->submit($form);
        $this->assertEquals('Ens\LionelBundle\Controller\JobController::createAction', $client->getRequest()->attributes->get('_controller'));
    }
