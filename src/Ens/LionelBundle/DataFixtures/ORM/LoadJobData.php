<?php
namespace Ens\LionelBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setExpiresAt(new \DateTime('2020-10-10'));
        ...
        $job_extreme_sensio->setExpiresAt(new \DateTime('2020-10-10'));
